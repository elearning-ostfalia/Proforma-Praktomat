...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CheckStyleChecker.allowedErrors'
        db.add_column('checker_checkstylechecker', 'allowedErrors',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CheckStyleChecker.check_version'
        db.add_column('checker_checkstylechecker', 'check_version',
                      self.gf('django.db.models.fields.CharField')(default='check-6.2', max_length=16),
                      keep_default=False)

        # Deleting field 'SetlXChecker.libraryFile'
        db.delete_column('checker_setlxchecker', 'libraryFile')


    def backwards(self, orm):
        # Deleting field 'CheckStyleChecker.allowedErrors'
        db.delete_column('checker_checkstylechecker', 'allowedErrors')

        # Deleting field 'CheckStyleChecker.check_version'
        db.delete_column('checker_checkstylechecker', 'check_version')

        # Adding field 'SetlXChecker.libraryFile'
        db.add_column('checker_setlxchecker', 'libraryFile',
                      self.gf('checker.models.CheckerFileField')(default=0, max_length=500),
                      keep_default=False)
    ...
    models = {
        ...
        'checker.junitchecker': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'junit_version': ('django.db.models.fields.CharField', [], {'default': "'junit4.12'", 'max_length': '16'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'order': ('django.db.models.fields.IntegerField', [], {}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'required': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
