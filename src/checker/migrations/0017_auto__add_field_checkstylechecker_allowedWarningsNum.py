...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CheckStyleChecker.allowedWarningsNum'
        db.add_column('checker_checkstylechecker', 'allowedWarningsNum',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CheckStyleChecker.allowedWarningsNum'
        db.delete_column('checker_checkstylechecker', 'allowedWarningsNum')
    ...
    models = {
        ...
        'checker.checkstylechecker': {
            ...
            'allowedWarningsNum': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'always': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
