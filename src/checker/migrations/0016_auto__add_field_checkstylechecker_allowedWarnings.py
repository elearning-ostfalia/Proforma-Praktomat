...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CheckStyleChecker.allowedWarnings'
        db.add_column('checker_checkstylechecker', 'allowedWarnings',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CheckStyleChecker.allowedWarnings'
        db.delete_column('checker_checkstylechecker', 'allowedWarnings')
