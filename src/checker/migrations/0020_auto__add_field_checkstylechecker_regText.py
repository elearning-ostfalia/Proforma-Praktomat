...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CheckStyleChecker.regText'
        db.add_column('checker_checkstylechecker', 'regText',
                      self.gf('django.db.models.fields.CharField')(default='*', max_length=5000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CheckStyleChecker.regText'
        db.delete_column('checker_checkstylechecker', 'regText')
