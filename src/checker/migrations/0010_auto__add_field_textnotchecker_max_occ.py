...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TextNotChecker.max_occ'
        db.add_column('checker_textnotchecker', 'max_occ', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TextNotChecker.max_occ'
        db.delete_column('checker_textnotchecker', 'max_occ')
