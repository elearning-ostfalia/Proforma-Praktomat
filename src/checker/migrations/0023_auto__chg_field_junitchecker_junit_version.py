...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JUnitChecker.junit_version'
        db.alter_column('checker_junitchecker', 'junit_version', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'JUnitChecker.junit_version'
        db.alter_column('checker_junitchecker', 'junit_version', self.gf('django.db.models.fields.CharField')(max_length=16))
