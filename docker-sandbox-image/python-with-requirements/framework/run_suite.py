...
runner=xmlrunner.XMLTestRunner(output='./__result__')
# runner=xmlrunner.XMLTestRunner(output='unittest_results.xml')
runner.run(suite)
...
#with open('/result/unittest_results.xml', 'wb') as output:
